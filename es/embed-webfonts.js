 ...
 */
async function maybeYieldToMain(options, counter) {
    var _a, _b, _c;
    ...
    if (options.yieldBudget !== undefined) {
        const timeSinceLastYield = Date.now() - ((_b = (_a = counter.lastYieldTime) !== null && _a !== void 0 ? _a : options._startTime) !== null && _b !== void 0 ? _b : Date.now());
...
async function getUsedFonts(node, options) {
    var _a;
    const fonts = new Set();
    // eslint-disable-next-line no-underscore-dangle
    const counter = { count: 0, lastYieldTime: (_a = options._startTime) !== null && _a !== void 0 ? _a : Date.now() };
