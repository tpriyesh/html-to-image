...
exports.getFontEmbedCSS = exports.toBlob = exports.toJpeg = exports.toPng = exports.toPixelData = exports.toCanvas = exports.toSvg = exports.CaptureAbortedError = void 0;
var clone_node_1 = require("./clone-node");
Object.defineProperty(exports, "CaptureAbortedError", { enumerable: true, get: function () { return clone_node_1.CaptureAbortedError; } });
 ...
 */
function initializeOptions(node, options) {
    var initialized = __assign({}, options);
    // Initialize context for tracking progress
    if (options.nonBlocking ||
        options.maxNodes ||
        options.timeout ||
        options.onProgress) {
        var domNodes = estimateDOMComplexity(node);
        ...
        var estimatedTotalOps = Math.floor(domNodes * 2.5);
 ...
 */
function estimateDOMComplexity(node) {
 ...
 */
function checkDOMComplexity(node, options) {
    if (options.maxNodes) {
        var nodeCount = estimateDOMComplexity(node);
        if (nodeCount > options.maxNodes) {
            throw new clone_node_1.CaptureAbortedError("Capture aborted: DOM has ".concat(nodeCount, " nodes, exceeds maximum of ").concat(options.maxNodes), 'max_nodes');
        }
    }
}
function toSvg(node, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var opts, _a, width, height, clonedNode, datauri;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    opts = initializeOptions(node, options);
                    // Pre-flight check for DOM complexity
                    checkDOMComplexity(node, opts);
                    _a = (0, util_1.getImageSize)(node, opts), width = _a.width, height = _a.height;
                    return [4 /*yield*/, (0, clone_node_1.cloneNode)(node, opts, true)];
                case 1:
                    clonedNode = (_b.sent());
                    return [4 /*yield*/, (0, embed_webfonts_1.embedWebFonts)(clonedNode, opts)];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, embed_images_1.embedImages)(clonedNode, opts)];
                case 3:
                    _b.sent();
                    (0, apply_style_1.applyStyle)(clonedNode, opts);
...
function getFontEmbedCSS(node, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            opts = initializeOptions(node, options);
            return [2 /*return*/, (0, embed_webfonts_1.getWebFontCSS)(node, opts)];
        });
    });
}
