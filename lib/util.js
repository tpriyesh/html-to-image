...
exports.isInstanceOfElement = exports.nodeToDataURL = exports.svgToDataURL = exports.createImage = exports.canvasToBlob = exports.checkCanvasDimensions = exports.getPixelRatio = exports.getImageSize = exports.getStyleProperties = exports.toArray = exports.delay = exports.uuid = exports.resolveUrl = exports.maybeYield = exports.yieldToMain = void 0;
/**
...
function yieldToMain() {
    return new Promise(function (resolve) {
        if ('requestIdleCallback' in window) {
            ;
            window.requestIdleCallback(function () { return resolve(); }, { timeout: 16 });
        }
        else {
 ...
 */
function maybeYield(context, yieldEvery) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    context.nodeCount += 1;
                    if (!(context.nodeCount % yieldEvery === 0)) return [3 /*break*/, 2];
