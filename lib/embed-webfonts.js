 ...
 */
function maybeYieldToMain(options, counter) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var shouldYield, timeSinceLastYield, yieldEvery;
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (options.yieldBudget !== undefined) {
                        timeSinceLastYield = Date.now() - ((_b = (_a = counter.lastYieldTime) !== null && _a !== void 0 ? _a : options._startTime) !== null && _b !== void 0 ? _b : Date.now());
...
function getUsedFonts(node, options) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        function traverse(node) {
            return __awaiter(this, void 0, void 0, function () {
                var fontFamily, children, _i, children_1, child;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: 
                        // Yield periodically during font traversal
                        return [4 /*yield*/, maybeYieldToMain(options, counter)];
                        case 1:
                            // Yield periodically during font traversal
                            _a.sent();
                            fontFamily = node.style.fontFamily || getComputedStyle(node).fontFamily;
                        ...
                        case 2:
                            ...
                            child = children_1[_i];
                            if (!(child instanceof HTMLElement)) return [3 /*break*/, 4];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fonts = new Set();
                    counter = { count: 0, lastYieldTime: (_a = options._startTime) !== null && _a !== void 0 ? _a : Date.now() };
                    return [4 /*yield*/, traverse(node)];
                case 1:
                    _b.sent();
                    return [2 /*return*/, fonts];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    rules = _a.sent();
                    return [4 /*yield*/, getUsedFonts(node, options)];
                case 2:
                    usedFonts = _a.sent();
